...
For a source build, you need Git, Node.js 22.19+ (22.x) or 24.2+ (24.x), and pnpm 9.12.0. Node 25 and 26 are also covered by the weekly compatibility matrix; regular CI covers Node 22 and 24. Initial installation and build require access to public npm.
